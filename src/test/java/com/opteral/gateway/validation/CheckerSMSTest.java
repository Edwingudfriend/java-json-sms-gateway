...
public class CheckerSMSTest {
    ...
    public static Collection<Object[]> data() throws ParseException {
        ...
        okInstantSend2.setText(TestHelper.genString(Config.MAX_SMS_SIZE));
        ...
        badText2.setText(TestHelper.genString(Config.MAX_SMS_SIZE + 1));
        ...
        withoutDatetime.setDatetime(date2);
